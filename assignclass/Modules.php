...
class Module implements ModuleDefinitionInterface
{
    ...
    public function registerAutoloaders(DiInterface $di = null)
    {
        ...
        $loader->registerNamespaces(
            [
                "Modules\\Assignclass\\Controllers" => __DIR__."/controllers/",
                "Modules\\Assignclass\\Models"      => __DIR__."/models/",
                "Modules\\Assignclass\\Plugin"      => __DIR__."/plugin/",
